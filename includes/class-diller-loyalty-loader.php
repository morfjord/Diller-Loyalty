...
class Diller_Loyalty_Loader {
	...
	/**
	 * Registers a shortcode to the collection to be loaded with WordPress.
	 *
	 ...
	 *@since    2.0.0
	 */
	public function register_shortcode( $shortcode, $component, $callback) {
